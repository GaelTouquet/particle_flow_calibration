...
filename = 'output_gael_eta_Data'
#filename = 'charged_hadrons_100k_Data'
data1 = importData(filename)
print('imported')
#filename = 'prod2_200_400k_Data'
...
lim = 300                   # if ecal + hcal > lim, ecalib = math.nan
n_neighbors_ecal_eq_0=1000  # number of neighbors for ecal = 0
...
fig = plt.figure(figsize=(12,4))
#cProfile.run('usplt.plot_ecalib_over_etrue_functionof_ecal_hcal(KNNGF,data2)','plot_prof')
...
##eref/etrue in function of ecal,hcal
#fig = plt.figure(figsize=(12,4))
##cProfile.run('usplt.plot_ecalib_over_etrue_functionof_ecal_hcal(KNNGF,data2)','plot_prof')
#usplt.plot_eref_over_etrue_functionof_ecal_hcal(KNNGF,data2)
##plt.show()
#savefig(fig,directory,classname+"_eref_over_etrue_functionof_ecal_hcal.png")
#savefig(fig,'img_index/',classname+"_eref_over_etrue_functionof_ecal_hcal.png")
