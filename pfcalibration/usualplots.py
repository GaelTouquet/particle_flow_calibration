...
def plotCalibrationCurve(calib):
    ...
    plt.plot(h,t,lw=2)
    plt.xlabel(r"$E_{\rm hcal}$",fontsize=20)
    plt.ylabel(r"$E_{\rm true}$",fontsize=20)
...
def plot_ecalib_over_etrue_functionof_etrue(calib,dataToPredict):
    ...
    plt.xlabel(r"$E_{\rm true}$",fontsize=20)
...
def plot_ecalib_over_etrue_functionof_ecal_hcal(calib,dataToPredict):
    ...
    plt.colorbar(im)
    plt.title(r"$E_{\rm ecal} \neq 0$",fontsize = 15)
    plt.xlabel(r"$E_{\rm ecal}$",fontsize = 15)
    plt.ylabel(r"$E_{\rm hcal}$",fontsize = 15)
    plt.tight_layout()
...
def hist_ecalib(calib,dataToPredict):
    ...
    plt.xlabel(r"$E_{\rm calib}$",fontsize=20)
    plt.title(r"$E_{\rm ecal} = 0$",fontsize=20)
    plt.subplot(2,2,2)
